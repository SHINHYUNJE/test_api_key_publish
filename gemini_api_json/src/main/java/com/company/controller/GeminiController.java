...
public class GeminiController {
	...
	public String getGeminiResponse(String prompt) throws IOException {
		...
		aiApiService = (GeminiServiceImpl) context.getBean("geminiService");
		...
		System.out.println(".... " + ((GeminiServiceImpl) aiApiService).getGEMINI_API_KEY());
		...
		if (result.contains("실패") || result.contains("오류")) {
			...
			result = ((GptServiceImpl) aiApiService).generateContent(prompt, jsonFilePath);
		}
